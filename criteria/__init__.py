...
from criteria import poison_triplet,poison_proxynca,poison_proxynca_triplet,poison_triplet_c
...
def select(loss, opt, to_optim, batchminer=None):
    ...
    losses = {'triplet': triplet,
              ...
              'poison_triplet':poison_triplet,
              'poison_proxynca':poison_proxynca,
              'poison_proxynca_triplet':poison_proxynca_triplet,
              'poison_triplet_c':poison_triplet_c,}

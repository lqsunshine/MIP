...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--batch_mining',    default='random',    type=str,   help='Batchminer for tuple-based losses: For supported methods, please check batch_mining/__init__.py') #distance
    ...
    # parser.add_argument('--evaluation_metrics', nargs='+', default=['e_recall@1', 'e_recall@2', 'e_recall@4', 'nmi', 'f1', 'mAP_1000', 'mAP_c',], type=str, help='Metrics to evaluate performance by.')
    parser.add_argument('--evaluation_metrics', nargs='+', default=['e_recall@1', 'e_recall@2', 'e_recall@4', 'e_recall@8', 'mAP_500', 'mAP_1000', 'mAP_1500','mAP_2000','nmi', 'f1', 'mAP_c'], type=str, help='Metrics to evaluate performance by.')
...
def wandb_parameters(parser):
    ...
    parser.add_argument('--online_backend', default='wandb', type=str)
    ...
    parser.add_argument('--wandb_key',       default='8a9d157b766ce88a903f1e143d2b7e53abde3e33',  type=str,   help='API key for W&B.')
    ...
    parser.add_argument('--group',           default='CUB_Triplet_Random',         type=str,   help='Name of the group - relates to W&B group names - all runs with same setup but different seeds are logged into one group. In --savename default setting part of the savename.')
    return parser
...
def backdoor_parameters(parser):
    ...
    parser.add_argument('--lambda2', default=0.0, type=float, help='weight of Loss2')
    parser.add_argument('--lambda3', default=1.0, type=float, help='weight of Loss3')
    parser.add_argument('--lambda4', default=1.0, type=float, help='weight of Loss4')

    #CBL
    parser.add_argument('--plambda1', default=1.0, type=float, help='weight of Loss1')
    parser.add_argument('--plambda2', default=1.0, type=float, help='weight of Loss2')
    return parser
